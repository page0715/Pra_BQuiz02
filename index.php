...
<body>
	...
	<div id="all">
		...
		<div id="title2" title="健康促進網-回首頁">
			<a href="/index.php" style="float: right;"><img src="./icon/02B01.jpg" alt=""></a>
		</div>
		...
		<div id="mm">
			...
			<div class="hal" id="main">
				<div>
					<marquee style="width:78%; display:inline-block;">請民眾踴躍投搞電子報，讓電子報成為大家相互交流、分享的園地!詳見最新文章</marquee>
